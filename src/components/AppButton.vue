...
export default {
  ...
  computed: {
    disabledBbtn() {
      ...
      } else {                                  // мне показалось слишком легким, да и по идее эту логику нужно выносить в
        return this.isDisable                   // компонент, к которому она пренадлежит. Однако мой вариант мне кажется слишком
